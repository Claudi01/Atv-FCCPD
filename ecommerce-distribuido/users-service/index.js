...
const PORT = 5001;
const SECRET_KEY = 'minha_chave_secreta_super_segura'; // Em produção, usar variável de ambiente
...
app.post('/users/login', async (req, res) => {
    ...
    // Gerando o Token com os dados do usuário (payload)
...
app.get('/users/:id', (req, res) => {
    ...
    try {
        ...
        // Regra simples: só pode ver se for o dono do ID ou um admin
